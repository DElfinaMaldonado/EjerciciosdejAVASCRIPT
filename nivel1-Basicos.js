...
//  De estos ejercicios no emdes pistas ni nada, solo dame ejemplo:
// Ejercicio 1 > 2 errores
// Ejercicio 2 > 4 errores
...
let temperatura_agua = 30;
if (temperatura_agua >= 24 && temperatura_agua <= 30) {
    console.log("Tiene acceso a la piscina");
} else {
    console.log("No tiene acceso a la piscina");
}
...
let capacidad_total = 80;
let cantidad_comensales = 40;
let capacidad_disponible = capacidad_total - cantidad_comensales;

let grupo_personas = 40;
let permitir_entrada = capacidad_disponible + grupo_personas;

if (permitir_entrada > 80) {
    console.log("No se permite la entrada");
} else if (permitir_entrada <= 80) {
    console.log("Permitir la entrada");
}
...
let total_credito = limite_tarjeta - saldo_actual;
let monto_compra = 50000;
// let realizar_compra =  monto_compra / total_credito;

if(monto_compra <= total_credito ){
...
let preguntas_correctas = 36;
if (preguntas_correctas >= 45) {
    console.log("Obtiene mención honorífica");
...
if (humedad_tierra >= 40) {
    console.log("La planta no necesit riego");
...
let edad_persona = 21;
let licencia_vigente = 2;
if (edad_persona >= 21 && licencia_vigente >= 2) {
...
let noches_entre_semana = 3;
let precio_entre_semana = 800;
let total_entre_semana = precio_entre_semana * noches_entre_semana;
console.log(total_entre_semana);

let noches_fin_semana = 2;
let precio_fin_semana = 1200;
let total_fin_semana = precio_fin_semana * noches_fin_semana;
console.log(total_fin_semana);
